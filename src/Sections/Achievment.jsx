...
const Achievment = () => {
  return (
    <div>
      ...
      <div className='border-4 rounded-full w-16 h-16 border-white font-bold mt-28 md:ml-16'>
      ...
      {/* 2nd div */}
      <div className='md:flex md:ml-[19rem] flex'>
        <h1 className='text-white mt-32 ml-5 font-serif font-semibold hidden md:block'>Oct 2023 - Mar 2024</h1>
        <div className='border-4  rounded-full w-16 h-16 border-white font-bold mt-28 md:ml-16 ml-3'>
          <img className='w-11 h-10 ml-1.5 mt-2' src={Toast} alt="" />
        </div>
        <div className='border-2 border-gray-800 md:w-[29rem] md:h-56 mt-28 md:ml-7 ml-0 text-white bg-gray-800 rounded-lg cursor-pointer w-80 h-auto'>
