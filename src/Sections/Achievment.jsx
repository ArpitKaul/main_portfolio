  ...
  return (
    <div id='achievements'>
      ...
      <div className='md:flex md:ml-[19rem]'>
        ...
        <div className='border-4  rounded-full w-16 h-16 border-white font-bold mt-28 ml-16'>
          <img className='w-11 h-10 ml-1.5 mt-2' src={Toast} alt="" />
        </div>
        <div className='border-2 border-gray-800 md:w-[29rem] md:h-56 mt-28 ml-7 text-white bg-gray-800 rounded-lg cursor-pointer'>
